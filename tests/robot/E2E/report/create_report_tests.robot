...
Successful Create Report - Normal Data
    ...
    Click Create Report
    Input Report Details With Data    TestFirst    TestLast    01/15/1990    1234567890    [E2E_TEST] Report Title    This is a normal report description.    This is normal report content for the therapy session.
...
Create Report - Title Over 100 Characters
    ...
    Should See Reports Page
    Click Create Report
    Input Report Details With Data    TestFirst    TestLast    01/15/1990    1234567890    [E2E_TEST] This is a very long title that definitely exceeds one hundred characters and should test the maximum length validation for the title field in the form    Short description.    Normal content.
...
Create Report - Missing Required Field
    ...
    Input Report Details With Data    ${EMPTY}    TestLast    01/15/1990    1234567890    [E2E_TEST] Test Report Title    Test description.    Test content.
...
Create Report - Future Birth Date
    ...
    Should See Reports Page
    Click Create Report
    Input Report Details With Data    TestFirst    TestLast    01/01/3000    1234567890    [E2E_TEST] Invalid Birth Date    Test description.    Test content.
    Verify Report Creation Failed
    Close Browser Safely
...
Create Report - Invalid Phone Number
    ...
    Should See Reports Page
    Click Create Report
    Input Report Details With Data    TestFirst    TestLast    01/15/1990    abc123    [E2E_TEST] Invalid Phone    Test description.    Test content.
    Verify Report Creation Failed
    Close Browser Safely
